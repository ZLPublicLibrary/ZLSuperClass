...
///事件条的高度
#define ZL_Action_Bar_Height 34.0
///分割线的高度
#define ZL_Line_Size_Height 0.5
///底部空间预留高度
#define ZL_Bottom_Space_Height 5.0


//TODO:颜色
///分割线
#define ZL_line_color [UIColor colorWithWhite:227.0 / 255.0 alpha:1.0]
///文字黑色
#define ZL_Text_Black_color [UIColor colorWithWhite:51.0 / 255.0 alpha:1.0]
